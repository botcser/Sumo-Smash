...
namespace Assets.ToonWater.Scripts.Core
{
    public class ToonWaterFloatObject:MonoBehaviour{
        ...
        bool ripple;
        public global::ToonWater water;						//Points to the ToonWater script
        ...
        public void FixedUpdate() {
            if(inWater){	//
                ...
                if(water.currentMultiplier > 0){
                    GetComponent<Rigidbody>().AddForce(global::ToonWater.scrollSpeedX*water.currentMultiplier*GetComponent<Rigidbody>().mass,0.0f,global::ToonWater.scrollSpeedZ*water.currentMultiplier*GetComponent<Rigidbody>().mass);
                }
                bob();
