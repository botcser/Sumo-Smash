...
//		GUILayout.Space(6);
	...
	private void CopyModules(ParticleSystem source, ParticleSystem dest)
	{
		...
		if(b_modules[0])
		{
            ...
            main.startDelay = source.main.startDelayMultiplier;
	...
	private void ScaleParticleValues(ParticleSystem ps, GameObject parent)
	{
		...
		//Particle System
		main.startSizeMultiplier *= ScalingValue;
        main.gravityModifierMultiplier *= ScalingValue;
		if(main.startSpeedMultiplier > 0.01f)
            main.startSpeedMultiplier *= ScalingValue;
